...
class DeploymentInputs(unittest.TestCase):
    ...
    def test_packaging_excludes_private_data_and_includes_templates_and_license(self):
        with tempfile.TemporaryDirectory() as folder:
            ...
            for name in ("nasfind/__init__.py","scripts/deploy_remote.py","examples/server-config.json","LICENSE","AGENTS.md", ".local/access.json","desktop/private.txt","nasfind/__pycache__/cached.pyc"):
